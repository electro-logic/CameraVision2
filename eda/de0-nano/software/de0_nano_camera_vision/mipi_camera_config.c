...
const CameraRegister CAMERA_REGISTERS[] = {
		...
		//{0x3018, 0x72},	// mipi_lane_mode	4 lane
		//{0x3018, 0x32},	// mipi_lane_mode	2 lane
		{0x3018, 0x12},		// mipi_lane_mode	1 lane
...
//	   {0x380f, 0x88}, // VTS L
		...
		{0x5000, 0x86}, // LENC on, MWB off, BPC on, WPC on [MWB ON in terasic examples]
		{0x5001, 0x01}, // BLC on
