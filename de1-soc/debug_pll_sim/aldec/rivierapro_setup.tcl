...
# ACDS 18.1 646 win32 2024.04.20.12:18:02
# ----------------------------------------
...
# ----------------------------------------
# If debug_pll is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/debug_pll.vho"
}
