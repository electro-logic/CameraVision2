...
MEM_0 := qsys_memory_system
$(MEM_0)_NAME := memory_system
...
$(MEM_0)_START := 0x02020000
$(MEM_0)_END := 0x02029fff
$(MEM_0)_SPAN := 0x0000a000
$(MEM_0)_HIERARCHICAL_PATH := memory_system
$(MEM_0)_WIDTH := 32
...
.PHONY: memory_system
memory_system: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
