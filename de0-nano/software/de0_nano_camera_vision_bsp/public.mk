...
# setting SOPC_SYSID_BASE_ADDRESS is 0x20004a8
SOPC_SYSID_FLAG += --sidp=0x20004a8
ELF_PATCH_FLAG  += --sidp 0x20004a8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1697016867
SOPC_SYSID_FLAG += --timestamp=1697016867
ELF_PATCH_FLAG  += --timestamp 1697016867
