...
# Wed Oct 04 16:21:58 CEST 2023
# DO NOT MODIFY


# 
# ft232h "ft232h" v2.0
# Leonardo Tazzini 2023.10.04.16:21:58
# USB 2.0 interface with FDTI FT232H IC
# 
...
# module ft232h
# 
set_module_property DESCRIPTION "USB 2.0 interface with FDTI FT232H IC"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avalon_ft232h
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avalon_ft232h.vhd VHDL PATH avalon_ft232h.vhd TOP_LEVEL_FILE
...
add_interface_port avalon avalon_address address Input 4
add_interface_port avalon avalon_write write Input 1
add_interface_port avalon avalon_writedata writedata Input 8
add_interface_port avalon avalon_read read Input 1
add_interface_port avalon avalon_readdata readdata Output 8
...
add_interface_port conduit_end nOE nOE Output 1
add_interface_port conduit_end nTXE nTXE Input 1
add_interface_port conduit_end nRXF nRXF Input 1
add_interface_port conduit_end nRD nRD Output 1
add_interface_port conduit_end nWR nWR Output 1
add_interface_port conduit_end nSIWU nSIWU Output 1
add_interface_port conduit_end ADBUS adbus Bidir 8
...
set_interface_property avalon_master_0 addressUnits WORDS
...
add_interface_port avalon_master_0 avm_writedata writedata Output 8
...
add_interface_port avalon_master_0 avm_readdata readdata Input 8
